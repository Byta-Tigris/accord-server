...
from insights.views import RetrievePlatformInsightsView, RetrieveSocialMediaHandleView
...
urlpatterns = [
    ...
    path("insights/handle/<str:handle>", RetrieveSocialMediaHandleView.as_view(), name="handle-insights")
]